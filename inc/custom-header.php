			...
			<div class="entry-container">
				...
				<div class="entry-container-wrap">
					<header class="entry-header">
						<?php
						$tagline = get_theme_mod( 'chique_header_media_tagline' );
						
						if ( is_front_page() && $tagline ) : ?>
						<div class="entry-tagline"><?php echo esc_html( $tagline ); ?></div>
						<?php endif; ?>
...
if ( ! function_exists( 'chique_has_header_media_text' ) ):
	...
	function chique_has_header_media_text() {
		$enable = get_theme_mod( 'chique_header_media_option', 'entire-site' );
		$header_media_tagline  = get_theme_mod( 'chique_header_media_tagline' );
		...
		if ( ( is_front_page() && ! $header_media_tagline && ! $header_media_title && ! $header_media_logo && ! $header_media_subtitle && ! $header_media_text && ! $header_media_url && ! $header_media_url_text ) || ( ( is_singular() || is_archive() || is_search() || is_404() ) && ! $header_image ) ) {
